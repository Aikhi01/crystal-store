  ...
  return (
    <div className="card p-8">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="flex justify-between mb-1">
            ...
            <Link href="/auth/forgot-password" className="text-sm text-crystal-600 hover:underline">Forgot password?</Link>
          </div>
      ...
      <p className="text-center text-sm text-gray-500 mt-5">
        ...
        <Link href="/auth/signup" className="text-crystal-600 hover:underline font-medium">Create one free</Link>
      </p>
    </div>
  )
}
